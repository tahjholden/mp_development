...
export default function PlayerDevelopmentPlan({ playerId, features }: PlayerDevelopmentPlanProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-[#d8cc97]">My Development Plan</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-3 bg-zinc-800/50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-white">Improve Ball Handling</p>
              <p className="text-xs text-zinc-400">Complete daily dribble drills</p>
            </div>
          ...
          <div className="flex items-center space-x-3 p-3 bg-zinc-800/50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-white">Increase Shooting Accuracy</p>
      ...
      <UniversalCard.Default title="Recent Activities">
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-2">
            ...
            <div className="flex-1">
              <p className="text-sm text-white">Completed dribble drill session</p>
